...
import spirent.methodology.ExpandProtocolMix2Command as ExpProtoMixCmd
...
def test_devices_per_block(stc):
    ...
    w_dev_list = west_template.GetObjects("EmulatedDevice",
                                         RelationType("GeneratedObject"))
    e_dev_list = east_template.GetObjects("EmulatedDevice",
                                         RelationType("GeneratedObject"))
    n_dev_list = north_template.GetObjects("EmulatedDevice",
                                         RelationType("GeneratedObject"))
    s_dev_list = south_template.GetObjects("EmulatedDevice",
                                         RelationType("GeneratedObject"))
...
def test_expand_run_validate(stc):
    ...
    plLogger.LogInfo("start.test_ExpandProtocolMix2Command.test_expand_run_validate")
    ctor = CScriptableCreator()
