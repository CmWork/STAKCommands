...
def get_meta_json_file_dict(json_path):
    ...
    plLogger.LogDebug('begin.get_meta_json_file_dict.ConfigMethodologyTestCommand')
    ...
    plLogger.LogDebug('end.get_meta_json_file_dict.ConfigMethodologyTestCommand')
    return meta_json, ""
...
def parse_meta_json_keys_values(meta_json):
    plLogger = PLLogger.GetLogger('methodology')
    plLogger.LogDebug('begin.parse_meta_json_keys_values.ConfigMethodologyTestCommand')
    ...
    plLogger.LogDebug('end.parse_meta_json_keys_values.ConfigMethodologyTestCommand')
    return key_val_dict, gui_key_val_dict
...
def run_the_proc_func(proc_func, input_dict):
    plLogger = PLLogger.GetLogger('methodology')
    plLogger.LogDebug('begin.run_the_proc_func.ConfigMethodologyTestCommand.')
...
def process_functions(meta_json, key_val_dict):
    plLogger = PLLogger.GetLogger('methodology')
    plLogger.LogDebug('begin.process_functions.ConfigMethodologyTestCommand.')
...
def validate(StmTestCase, EnableResourceCheck):
    plLogger = PLLogger.GetLogger('methodology')
    plLogger.LogDebug('begin.validate.ConfigMethodologyTestCommand.')
    result = ''
    ...
    if test_case is None or not test_case.IsTypeOf('StmTestCase'):
        ...
        result = 'Could not find StmTestCase'
    plLogger.LogDebug('end.validate.ConfigMethodologyTestCommand')
    return result


def run(StmTestCase, EnableResourceCheck):
    plLogger = PLLogger.GetLogger('methodology')
    plLogger.LogDebug('begin.run.ConfigMethodologyTestCommand')
    ...
    plLogger.LogDebug('end.run.ConfigMethodologyTestCommand')
    return True
